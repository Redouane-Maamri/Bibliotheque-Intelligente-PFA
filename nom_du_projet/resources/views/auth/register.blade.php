...
<body class="min-h-screen bg-white text-green-800 flex items-center justify-center">
    ...
    <div class="flex flex-col md:flex-row w-full max-w-7xl mx-auto bg-white shadow-lg rounded-3xl overflow-hidden">
        ...
        <div class="md:w-1/2 p-10 animate-fadeIn">
            <h2 class="text-4xl font-extrabold text-green-600 mb-4 text-center">📘 Join BookVerse</h2>
            <p class="text-green-700 text-center mb-6">Create an account and dive into a world of stories.</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Name -->
                <div class="mb-4">
                    <label for="name" class="block text-sm font-semibold text-green-800 mb-1">Name</label>
                    ...
                    <x-input-error :messages="$errors->get('name')" class="text-red-400 mt-1 text-sm"/>
                </div>
                ...
                <!-- Confirm Password -->
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-sm font-semibold text-green-800 mb-1">Confirm Password</label>
                    <input id="password_confirmation" name="password_confirmation" type="password" required
                           class="w-full px-4 py-2 rounded-lg bg-white border-2 border-green-300 text-green-800 placeholder-green-400 focus:outline-none focus:ring-2 focus:ring-green-400">
                    <x-input-error :messages="$errors->get('password_confirmation')" class="text-red-400 mt-1 text-sm"/>
                </div>

                <!-- Submit -->
                <div class="flex items-center justify-between">
                    <a href="{{ route('login') }}" class="text-sm underline text-green-800 hover:text-green-600">Already registered?</a>
